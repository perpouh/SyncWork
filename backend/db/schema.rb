...
ActiveRecord::Schema[7.2].define(version: 2025_04_20_073715) do
  ...
  create_table "projects", id: :string, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
